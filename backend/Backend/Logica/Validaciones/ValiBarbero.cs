...
{
    public class ValiBarbero
    {
        public static List<Error> insertar(ReqInsertarBarbero req)
        {
        ...
        public static List<Error> actualizar(ReqActualizarBarbero req)
        {
            List<Error> errores = new List<Error>();
            Helpers helpers = new Helpers();
        ...
        public static List<Error> eliminar(ReqEliminarBarbero req)
        {
            List<Error> errores = new List<Error>();
            Helpers helpers = new Helpers();
